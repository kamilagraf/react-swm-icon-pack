...
const Calendar = ({ color, strokeWidth, set }) => {
  ...
  const Curved = () => (
    <g>
      ...
      <path d="M3.51733 11.5H20.4826" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
      <path
  ...
  const Duotone = () => (
    <g>
      ...
      <path d="M4 11H20" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
      <path
