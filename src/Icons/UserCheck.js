...
const UserCheck = ({ color, strokeWidth, set }) => {
  const Broken = () => (
    <g>
      <path d="M23 9L19.8 12.1999L18 10.4" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path
  ...
  const Curved = () => (
    <g>
      <path d="M23 9L18.8001 13.1999L17.0001 11.4" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path
  ...
  const Duotone = () => (
    <g>
      <path
        ...
        fill={color}
      />
      <path d="M23 9L19.8001 12.1999L18 10.4" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path
