...
const Music = ({ color, strokeWidth, set }) => {
  const Broken = () => (
    <g>
      <path d="M20 16.5V10" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
      <path d="M9 17.5V6L20 3V6" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
      <path
  ...
  const Duotone = () => (
    <g>
      ...
      <path d="M9 17.5V6L20 3V16.5" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
      <path
