...
const Syringe = ({ color, strokeWidth, set }) => {
  const Broken = () => (
    <g>
      <path d="M5.34324 18.6569L3.22192 20.7782" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path
      ...
      <path
        ...
        stroke-linejoin="round"
      />
      <path d="M18.7781 5.22192L16.6567 7.34324" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path
  ...
  const Curved = () => (
    <g>
      ...
      <path
        ...
        stroke-linejoin="round"
      />
      <path d="M18.7781 5.22186L16.6567 7.34318" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path
