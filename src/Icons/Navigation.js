...
const Navigation = ({ color, strokeWidth, set }) => {
  const Broken = () => (
    <g>
      <path d="M12 17L19 20L12 3L5 20L8.5 18.5" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
    </g>
  );
  const Curved = () => (
    <g>
  ...
  const Duotone = () => (
    <g>
      ...
      <path d="M19 20L12 3L5 20L12 17L19 20Z" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
    </g>
  );
  const Outline = () => (
    <g>
