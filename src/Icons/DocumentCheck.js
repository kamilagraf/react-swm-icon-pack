...
const DocumentCheck = ({ color, strokeWidth, set }) => {
  const Broken = () => (
    <g>
      <path d="M15 12L10.8 16L9 14.2857" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
  ...
  const Curved = () => (
    <g>
      <path d="M15.0001 12L10.8001 16.2L9.00003 14.4" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
      <path
