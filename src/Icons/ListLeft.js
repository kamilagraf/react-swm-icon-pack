...
const ListLeft = ({ color, strokeWidth, set }) => {
  const Broken = () => (
    <g>
      ...
      <path d="M11 16H17" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
  ...
  const Curved = () => (
    <g>
      ...
      <path d="M12 16H16" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
      <path
