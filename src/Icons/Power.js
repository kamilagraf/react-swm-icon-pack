...
const Power = ({ color, strokeWidth, set }) => {
  const Broken = () => (
    <g>
      <path d="M5 14C5 11.6212 6.18652 9.51963 8 8.25468" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path
      ...
      />
      <path d="M12 4V12" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
    </g>
  );
  const Curved = () => (
    <g>
