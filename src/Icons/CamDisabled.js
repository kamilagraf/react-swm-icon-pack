...
const CamDisabled = ({ color, strokeWidth, set }) => {
  const Broken = () => (
    <g>
      ...
      <path
        ...
        stroke-linejoin="round"
      />
      <path d="M21 17V7L18.5 8" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
    </g>
  );
  const Curved = () => (
    <g>
  ...
  const Duotone = () => (
    <g>
      <path d="M3 8V17.5C3 18.0523 3.44772 18.5 4 18.5H14" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path d="M3 3L21 21" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path
        d="M10 5.5H15C15.5523 5.5 16 5.94772 16 6.5V9V11"
        stroke={color}
        ...
        stroke-linejoin="round"
      />
      <path d="M21 17V7L16 9" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
    </g>
  );
  const Outline = () => (
    <g>
