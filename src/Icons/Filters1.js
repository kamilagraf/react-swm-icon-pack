...
const Filters1 = ({ color, strokeWidth, set }) => {
  const Broken = () => (
    <g>
      <path d="M19 7V4" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" />
      <path d="M19 14V20" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" />
      <path d="M12 16V10" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" />
      <path d="M12 7V4" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" />
      <path d="M5 11V20" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" />
      <path
  ...
  const Curved = () => (
    <g>
      <path d="M19 10V4" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" />
      <path d="M19 14V20" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" />
      <path d="M12 16V4" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" />
      <path d="M5 8V20" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" />
      <path
        d="M5 8C6.10457 8 7 7.10457 7 6C7 4.89543 6.10457 4 5 4C3.89543 4 3 4.89543 3 6C3 7.10457 3.89543 8 5 8Z"
        stroke={color}
        strokeWidth={strokeWidth}
