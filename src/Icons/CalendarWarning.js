...
const CalendarWarning = ({ color, strokeWidth, set }) => {
  const Broken = () => (
    <g>
      <path d="M20 12V18.5" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path d="M20 21V21.01" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
  ...
  const Curved = () => (
    <g>
      ...
      <path d="M3.51733 11.5L15 11.5" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path
