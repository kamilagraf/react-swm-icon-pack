...
const Edit2 = ({ color, strokeWidth, set }) => {
  const Broken = () => (
    <g>
      <path d="M12 20H20.5" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
  ...
  const Curved = () => (
    <g>
      <path d="M12.4445 19.6875H20.9445" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path
