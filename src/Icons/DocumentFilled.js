...
const DocumentFilled = ({ color, strokeWidth, set }) => {
  const Broken = () => (
    <g>
      <path d="M8 13H14" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
      <path d="M8 17H16" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
  ...
  const Curved = () => (
    <g>
      <path d="M9 13H13" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
