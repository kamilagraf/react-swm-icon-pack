...
const DocumentPlus = ({ color, strokeWidth, set }) => {
  const Broken = () => (
    <g>
      <path d="M12 11V14V17" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
      <path d="M9 14H12H15" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
  ...
  const Curved = () => (
    <g>
      <path d="M12 11V17M9 14H15" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
