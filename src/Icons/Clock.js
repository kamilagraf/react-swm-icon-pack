...
const Clock = ({ color, secondaryColor, strokeWidth, set }) => {
  ...
  const Curved = () => (
    <g>
      <path d="M12 7v5l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
    </g>
  );
  const Duotone = () => (
    <g>
  ...
  const TwoColor = () => (
    <g>
      <path d="M12 7v5l3 3" stroke={secondaryColor} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
