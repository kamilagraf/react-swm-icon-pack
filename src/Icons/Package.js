...
const Package = ({ color, strokeWidth, set }) => {
  const Broken = () => (
    <g>
      <path d="M10 13H14" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path d="M19 13V20H5V9" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path
  ...
  const Duotone = () => (
    <g>
      ...
      <path d="M10 13H14" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path d="M19 9V20H5V9" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path
