...
const Cam = ({ color, strokeWidth, set }) => {
  const Broken = () => (
    <g>
      ...
      />
      <path d="M16 15L21 17V7L18.5 8" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
    </g>
  );
  const Curved = () => (
    <g>
  ...
  const Duotone = () => (
    <g>
      ...
      <path
        ...
        stroke-linejoin="round"
      />
      <path d="M16 9L21 7V17L16 15" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
    </g>
  );
  const Outline = () => (
    <g>
