...
const ChevronCircleRight = ({ color, secondaryColor, strokeWidth, set }) => {
  const Broken = () => (
    <g>
      <path
...
ChevronCircleRight.displayName = 'SvgChevronCircleRight';
export default createIcon(ChevronCircleRight);
