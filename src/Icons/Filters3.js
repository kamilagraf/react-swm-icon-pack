...
const Filters3 = ({ color, strokeWidth, set }) => {
  const Broken = () => (
    <g>
      <path d="M9 12L4 4H15" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path d="M20 4L15 12V21L9 18V16" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
    </g>
  );
  const Curved = () => (
    <g>
  ...
  const Duotone = () => (
    <g>
      ...
      <path d="M4 4L9 12V18L15 21V12L20 4H4Z" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
    </g>
  );
  const Outline = () => (
    <g>
