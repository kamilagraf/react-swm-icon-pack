...
const RotateRightCircle = ({ color, secondaryColor, strokeWidth, set }) => {
  const Broken = () => (
    <g>
      <path
...
RotateRightCircle.displayName = 'SvgRotateRightCircle';
export default createIcon(RotateRightCircle);
