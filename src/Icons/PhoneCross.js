...
const PhoneCross = ({ color, strokeWidth, set }) => {
  const Broken = () => (
    <g>
      <path d="M21 3L15 9" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path d="M15 3L21 9" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path
