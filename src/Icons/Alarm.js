...
const Alarm = ({ color, secondaryColor, strokeWidth, set }) => {
  const Broken = () => (
    <g>
      <path id="shape" d="M12 9V13L14 15" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path
        id="shape_2"
      ...
      />
      <path id="shape_3" d="M18 3L21 6" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path id="shape_4" d="M3 6L6 3" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
    </g>
  );
  const Curved = () => (
    <g>
