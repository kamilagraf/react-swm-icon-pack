...
const UserCross = ({ color, strokeWidth, set }) => {
  const Broken = () => (
    <g>
      <path d="M22 9L18 13" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
      <path d="M18 9L22 13" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
      <path
