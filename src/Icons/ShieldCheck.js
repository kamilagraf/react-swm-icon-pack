...
const ShieldCheck = ({ color, strokeWidth, set }) => {
  const Broken = () => (
    <g>
      <path d="M10 10L12 12L14 14" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path d="M10 14L12 12L14 10" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path
  ...
  const Curved = () => (
    <g>
      ...
      <path d="M10 14L14 10" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path
