...
const Grid4 = ({ color, strokeWidth, set }) => {
  const Broken = () => (
    <g>
      <path d="M3.5 3.5H10.5V10.5H3.5V3.5Z" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path d="M5 13.5H3.5V20.5H10.5V13.5H9" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path d="M13.5 5V3.5H20.5V10.5H13.5V9" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path d="M13.5 13.5H20.5V20.5H13.5V13.5Z" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
    </g>
  );
  const Curved = () => (
    <g>
  ...
  const Duotone = () => (
    <g>
      ...
      <path d="M3.5 3.5H10.5V10.5H3.5V3.5Z" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path d="M3.5 13.5H10.5V20.5H3.5V13.5Z" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path d="M13.5 3.5H20.5V10.5H13.5V3.5Z" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path d="M13.5 13.5H20.5V20.5H13.5V13.5Z" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
    </g>
  );
  const Outline = () => (
