...
const CalendarEdit = ({ color, strokeWidth, set }) => {
  const Broken = () => (
    <g>
      <path d="M18.5883 16.2941L16.7059 14.4118" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path
  ...
  const Curved = () => (
    <g>
      <path d="M18 13L12 19V21H14L20 15L18 13Z" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path d="M16.5 14.5L18.5 16.5" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
  ...
  const Duotone = () => (
    <g>
      <path d="M18.5882 16.2941L16.7059 14.4118" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path
        d="M12 19.1176V21H13.8824L20 14.8824L18.1176 13L12 19.1176Z"
        stroke={color}
        stroke-width={strokeWidth}
