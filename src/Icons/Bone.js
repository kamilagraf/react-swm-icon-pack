...
const Bone = ({ color, secondaryColor, strokeWidth, set }) => {
  const Broken = () => (
    <g>
      <path
        d="M14.107 12.721a8.204 8.204 0 012.154-1.548c.68-.337 1.48-.173 2.239-.173a2.5 2.5 0 10-.564-4.936A2.5 2.5 0 1013 5.5c0 .759.164 1.56-.173 2.239M11.949 15c-.297.397-.556.82-.776 1.262-.337.68-.173 1.48-.173 2.238a2.5 2.5 0 11-4.936-.564A2.5 2.5 0 115.5 13c.759 0 1.56.164 2.239-.173a8.208 8.208 0 002.154-1.548l.693-.693"
        stroke={color}
