...
const CalendarLink = ({ color, strokeWidth, set }) => {
  const Broken = () => (
    <g>
      ...
      <path
        ...
        stroke-linejoin="round"
      />
      <path d="M14 19H17" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
  ...
  const Curved = () => (
    <g>
      ...
      <path d="M3.51733 11.5H15" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path
