...
const ShieldCross = ({ color, strokeWidth, set }) => {
  const Broken = () => (
    <g>
      <path d="M15.5 9.5L11 14L9.5 12.5" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
      <path
  ...
  const Curved = () => (
    <g>
      <path d="M15.0001 10L11.0001 14L9 12" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
      <path
