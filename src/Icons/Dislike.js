...
const Dislike = ({ color, strokeWidth, set }) => {
  const Broken = () => (
    <g>
      <path d="M8 10V4" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path
  ...
  const Curved = () => (
    <g>
      <path d="M8 14V4" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path
