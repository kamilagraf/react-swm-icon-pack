...
const ChevronUpCircle = ({ color, secondaryColor, strokeWidth, set }) => {
  const Broken = () => (
    <g>
  ...
  const Curved = () => (
    <g>
      ...
      <path stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth={strokeWidth} d="M17 14l-5-5-5 5" />
    </g>
  );
  const Duotone = () => (
    <g>
...
export default createIcon(ChevronUpCircle);
