...
const Crown2 = ({ color, strokeWidth, set }) => {
  const Broken = () => (
    <g>
      <path d="M15.5 12.5L21 8L19 20H17" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path d="M8.5 12.5L12 7L13.9091 10" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path d="M12 20H5L3 8L6 10.4545" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path
