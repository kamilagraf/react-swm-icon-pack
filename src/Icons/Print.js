...
const Print = ({ color, strokeWidth, set }) => {
  const Broken = () => (
    <g>
      <path d="M8 15H16V18V21H8V18" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
      <path d="M16 18H20V9H16H8H4V18H8" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
      <path
  ...
  const Duotone = () => (
    <g>
      ...
      <path d="M16 15H8V18V21H16V18V15Z" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
      <path d="M16 18H20V9H16H8H4V18H8" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
      <path
