...
const Capsule = ({ color, strokeWidth, set }) => {
  const Broken = () => (
    <g>
      <path d="M8.42892 8.57104L12.8579 13" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path
  ...
  const Curved = () => (
    <g>
      <path d="M8.42896 8.57104L15.5 15.6421" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path
