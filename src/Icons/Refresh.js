...
const Refresh = ({ color, strokeWidth, set }) => {
  const Broken = () => (
    <g>
      <path d="M3 3V9H9" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path
      ...
      />
      <path d="M21 21V15L15 15" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path
