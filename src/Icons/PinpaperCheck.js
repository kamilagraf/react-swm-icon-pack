...
const PinpaperCheck = ({ color, strokeWidth, set }) => {
  const Broken = () => (
    <g>
      <path d="M15 12L10.8 16.2L9.00003 14.4" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
  ...
  const Curved = () => (
    <g>
      <path d="M15 12L10.8 16.2L9.00004 14.4" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
  ...
  const Duotone = () => (
    <g>
      ...
      <path d="M15 12L10.7999 16.2L9 14.4" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
  ...
  const Outline = () => (
    <g>
      <path d="M15 12L10.8 16.2L9.00006 14.4" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path d="M9 4.5H5V21H19V4.5H15" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path d="M15 3H9V4.5V6H15V4.5V3Z" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
    </g>
  );
