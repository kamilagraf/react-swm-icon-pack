...
const RefreshCircle = ({ color, strokeWidth, set }) => {
  const Broken = () => (
    <g>
      ...
      />
      <path d="M17 16V13.6H14.5" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
      <path
        ...
        strokeLinejoin="round"
      />
      <path d="M7 8V10.4H9.5" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
      <path
