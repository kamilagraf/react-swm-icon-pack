...
const DocumentCross = ({ color, strokeWidth, set }) => {
  const Broken = () => (
    <g>
      <path d="M14.5 11.5L12 14L9.5 16.5" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
      <path d="M9.50002 11.5L12 14L14.5 16.5" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
