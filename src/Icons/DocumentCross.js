...
const DocumentCross = ({ color, strokeWidth, set }) => {
  const Broken = () => (
    <g>
      <path d="M14.5 11.5L12 14L9.5 16.5" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path d="M9.50002 11.5L12 14L14.5 16.5" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
  ...
  const Curved = () => (
    <g>
      <path d="M9.5 11.5L14.5 16.5" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path d="M14.5 11.5L9.5 16.5" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path
