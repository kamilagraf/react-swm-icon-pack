...
const RotateLeftSmall = ({ color, secondaryColor, strokeWidth, set }) => {
  const Broken = () => (
    <g>
      <path
...
RotateLeftSmall.displayName = 'SvgRotateLeftSmall';
export default createIcon(RotateLeftSmall);
