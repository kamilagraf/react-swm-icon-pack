...
const Phone = ({ color, secondaryColor, strokeWidth, size, set }) => {
  ...
  const TwoColor = () => (
    <g>
      ...
      />
      <path
        d="M19.026 20.993C10 21 3 13.935 3.007 4.969 2.913 3.93 3.774 3.001 4.808 3h2.715c.44-.004.865.151 1.198.437.947.812 1.556 3.57 1.322 4.667-.183.856-1.046 1.455-1.633 2.04"
        stroke={color}
        strokeWidth={strokeWidth}
        strokeLinecap="round"
        strokeLinejoin="round"
