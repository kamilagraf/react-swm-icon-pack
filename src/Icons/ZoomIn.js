...
const ZoomIn = ({ color, strokeWidth, set }) => {
  const Broken = () => (
    <g>
      <path d="M20 20L14.9497 14.9497" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
      <path
      ...
      <path d="M10 7V13" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
    </g>
  );
  const Curved = () => (
    <g>
