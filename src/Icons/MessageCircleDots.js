...
const MessageCircleDots = ({ color, strokeWidth, set }) => {
  const Broken = () => (
    <g>
      <path d="M15.5 11.5H15.51" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
      <path d="M11.5 11.5H11.51" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
      <path d="M7.5 11.5H7.51" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
