...
const MessageCircleLines = ({ color, strokeWidth, set }) => {
  const Broken = () => (
    <g>
      <path d="M8 9.5H15" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
      <path d="M8 13.5H13" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
