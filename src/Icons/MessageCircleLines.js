...
const MessageCircleLines = ({ color, strokeWidth, set }) => {
  const Broken = () => (
    <g>
      <path d="M8 9.5H15" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path d="M8 13.5H13" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
