...
const Pin1 = ({ color, strokeWidth, set }) => {
  const Broken = () => (
    <g>
      <path d="M12 16V21" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
      <path
  ...
  const Curved = () => (
    <g>
      <path
        ...
        strokeLinejoin="round"
      />
      <path d="M12 13V21" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
    </g>
  );
  const Duotone = () => (
    <g>
